...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    fido = Dog2.new
    assert_equal [], fido.instance_variables # нет переменных
  ...
  class Dog5
    attr_accessor :name # Автоматически создаёт методы name и name=
  end
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so? - Количество аргументов должно совпадать
  end
