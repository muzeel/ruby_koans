...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # THINK ABOUT IT:
    # __send__ делает то же самое, но защищен от переопределения
  ...
  # respond_to? проверяет, есть ли у объекта такой метод
  # ------------------------------------------------------------------
  ...
  # respond_to? не знает о перехваченных методах
  # ------------------------------------------------------------------
